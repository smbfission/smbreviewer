	...
	<div class="container">
		<div class="col-md-8 reviews ">
			...
			<div class="review-container-step-1 ">
				<!-- if (trim($data['youtube'])!='' -->
				<?php if (false): ?> 
					<div class="video-responsive">
						<iframe width="420" height="315" src="<?=trim($data['youtube'])?>" frameborder="0" allowfullscreen></iframe>
					</div>
					<?php else: ?>
						<span class='refokus-logo'>Ref<span class='refokus-logo-o'>O</span>kus</span>
						<!-- <?php if (trim($data['logo'])!=''): ?> <img class="img-responsive center-block" src="/uploads/capture_reviews/<?=$data['logo']?>" alt="">
							<?php endif; ?> -->
							<?php endif; ?>
					<div class="title-container">
						<h1 class="text-center primary-font-color primary-font-family title">Can You Please Leave Us a Review?</h1> 
						<h3 class="secondary-font-color secondary-font-family desc">
							<!-- <?=$data['description']?> -->
							Please describe in detail your experience with our organization, thanks so much!
						</h3>
					</div>
                     ...
                     <div class="form-group text-review-container">
					  ...
					  >
                        <label for="email" class='reward-notice'>
							<!-- <?=$data['reward']?> -->
							As a thank you for your time, we will give you 25% off your next order, please list your email below.
						</label>
                        <div class="text-input-group">
							<input class="text-input" type="text" name="name" value="" placeholder="Your Email"  data-toggle="popover" data-placement="bottom" >
							<div class="input-group-addon input-icon-container">
								<svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" viewBox="0 0 18 20">
									<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 19v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M9 9a4 4 0 100-8 4 4 0 000 8z"/>
								</svg>
			   ...
			   <span class='refokus-logo'>Ref<span class='refokus-logo-o'>O</span>kus</span>
				...
				<div class='leftside-title-container'> 
					...
					<form class="form" id="feedback_form" method="post">
						...
						<div class="form-group text-review-container">
							<label for="message" >
								<h3 class='field-title'>Your Review</h3> </label>
							<p class="text-area uneditable">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Habitasse tempor purus vel nullam et gravida sapien. Iaculis diam dui, aliquet morbi sit sagittis, pellentesque. </p>
						</div>
						<input name="capture_reviews_token" type="hidden" value="<?= $form_token; ?>">
						<div class="text-center">
          ...
          <!-- ending step 2 -->
			...
			<div class="col-12">
				<form class="form text-center" id="share_form" method="post">
					...
					<div class="col-md-12 review-text-share ">
					...
					<div class='list-container'>
						<ul class="list-inline text-center center-block link-box-list">
							<!-- <?= isset($reviewData['type']) && $reviewData['type'] == 'text' ? '':'hidden' ?> -->
							<!-- ($data['enable_review_directories_google']==1 && trim($data['review_directories_google'])!='') -->
							<?php if (true): ?>
								<li>
								...
								<?php endif; ?>
								<!-- ($data['enable_review_directories_facebook']==1 && trim($data['review_directories_facebook'])!='') -->
									<?php if (true): ?>
										<li>
										...
										<?php endif; ?>
										<!-- ($data['enable_review_directories_yelp']==1 && trim($data['review_directories_yelp'])!='') -->
											<?php if (true): ?>
												<li>
