...
$templates = $db->getReviewTemplates();
...
<script type="text/javascript">
    ...
    let selectedTemplate = <?= isset($row['review_template_id']) ? json_encode($db->getReviewTemplate($row['review_template_id']), true) : json_encode($template, true) ?>
    ...
    function setTemplate(template) {
        ...
        $('#template-preview').attr('src', '/uploads/templates/previews/' + template.preview_image);
