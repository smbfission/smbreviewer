        ...
        <form action="/action.php?action=<?= isset($template) ? 'review_template_update&id=' . $template['id'] : 'review_template_add' ?>" method="post" class="form-horizontal form-bordered" id="template-form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 ">
                    ...
                    <button data-toggle="modal" data-target="#image-preview-modal" type="button" class="btn btn-fill btn-primary preview">Preview current image</button>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <button type="submit" name="submit" value="submit" class="btn btn-fill btn-success" id="template-form-submit">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php
                if (isset($template)) {
                    $data = htmlentities(file_get_contents('./uploads/templates/' . $template['template']));
                    echo $data;
                }
                ?>
                </pre>
            ...
            <div class="modal-footer">
                <button type="button" id="save" class="btn btn-secondary" data-dismiss="modal">Save</button>
    ...
    <div class="modal fade" id="image-preview-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img id="image-preview" src="/uploads/templates/previews/<?= $template['preview_image'] ?>">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                </div>
