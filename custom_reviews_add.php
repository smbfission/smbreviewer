...
<link rel="stylesheet" href="/assets/vendor/bootstrap-fileupload/bootstrap-fileupload.min.css" />
          ...
          <div class="row">
                    ...
                    <div class="form-group <?=( isset($row['loom_url']) && $row['loom_url'] != '' ?'':'hidden')?>">
										    <label class="col-md-3 control-label" for="inputDefault">Embed this Video</label>
											  <div class="col-md-6">
                          <textarea readonly style="width: 100%;" rows="5"><script type="text/javascript" src="https://calipio.com/app/embeddable.js?<?php echo $calipio_identifier. '#' .$calipio_password; ?>"></script></textarea>
                           <p style="font-size: 12px; color: #ccc;">Place the above code onto your website</p>
                        </div>
										</div>
										
											<!-- share the video Settings -->
										<div class="form-group <?=( isset($row['loom_url']) && $row['loom_url'] != '' ?'':'hidden')?>">
										    <label class="col-md-3 control-label" for="inputDefault">Share this Video</label>
											  <div class="col-md-6">
                         <p style="font-size: 12px; color: #ccc;">Share the following URL</p>
                          <p><a href="<?php echo 'https://reviews.smbreviewer.com/svl/'.base64_encode($_REQUEST['id']); ?>" target="_blank"><?php echo 'https://reviews.smbreviewer.com/svl/'.base64_encode($_REQUEST['id']); ?></a></p>
